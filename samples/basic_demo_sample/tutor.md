...
Ready for more advanced patterns? You already saw B2B APIs and Kafka events in Section 5 -
next up would be things this tour didn't cover:
- State transition logic (old_row) - e.g. "all raises must exceed 10%"
- Audit logging (copy_row)
- Testing with Behave

Just describe what you want in plain English and I'll build it into this project the same way we built everything else today.
